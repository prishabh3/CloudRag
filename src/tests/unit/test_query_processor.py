...
class TestQueryProcessor(unittest.TestCase):
    ...
    def test_handler_query_success(self, mock_generate, mock_search, mock_embed):
        ...
        # generate_response is called with the optional web_search_data argument
        # (None here, since no MCP server URL was supplied).
        mock_generate.assert_called_once_with("gemini-2.0-flash", "What is RAG?", mock_chunks, None)
