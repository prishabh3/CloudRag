...
# httpx is a runtime dependency of query_processor (MCP client) but is not
# installed in the unit-test environment (see tox.ini). Mock it so the module
# can be imported during test collection.
